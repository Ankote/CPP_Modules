...
/*   Updated: 2023/09/16 15:11:46 by aankote          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const ClapTrap &other)
{
    ...
    std::cout << "A new ClapTrap named " << other._Name;
...
ClapTrap &ClapTrap::operator=(const ClapTrap &other)
{
    ...
    this->_EnergyPoint  = other._EnergyPoint;
    this->_HitPoint     = other._HitPoint;
    std::cout << "ClapTrap " << " is being assigned the values of ";
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (_HitPoint > 0)
    {
        ...
        this->_EnergyPoint --;
        std::cout << "• ClapTrap " << this->_Name;
        std::cout << " repairs itself and gains " << amount;
        std::cout<< " hit points. Hit points remaining: ";
        std::cout << this->_HitPoint << std::endl;
    }
    else 
    {
        std::cout << "•• ClapTrap " << this->_Name;
        std::cout << " is already destroyed and can't be repaired." << std::endl;
    }
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
    if (_HitPoint > 0)
    {
        if (amount > (unsigned int)this->_HitPoint)
        {
            ...
            this->_EnergyPoint = 0;
            std::cout << "• ClapTrap " << this->_Name;
            std::cout << " takes " << amount << " damage and is destroyed." << std::endl;
        }
        else
        {
            this->_HitPoint -= amount;
            std::cout << "• ClapTrap " << this->_Name;
            std::cout << " takes " << amount << " damage. Hit points remaining: ";
            std::cout << this->_HitPoint << std::endl;
        }
    } 
    else
    {
            std::cout << "•• ClapTrap " << this->_Name;
            std::cout << " is already destroyed and can't take more damage." << std::endl;
     }
}
