...
/*   Updated: 2023/09/15 21:00:34 by aankote          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (_HitPoint > 0 && this->_EnergyPoint )
    {
        ...
        std::cout << amount << " hit points. Hit points remaining: ";
...
void ClapTrap::takeDamage(unsigned int amount)
{
    if (_HitPoint > 0  && this->_EnergyPoint )
    {
        if (amount > (unsigned int)this->_HitPoint)
        {
            ...
            std::cout << amount << " damage and is destroyed." << std::endl;
        }
        else
        {
            this->_HitPoint -= amount;
            std::cout << "• ClapTrap " << this->_Name << " takes " << amount;
            std::cout << " damage. Hit points remaining: " << this->_HitPoint << std::endl;
        }
    } 
    else
    {
