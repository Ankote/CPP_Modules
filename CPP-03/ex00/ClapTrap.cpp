...
/*   Updated: 2023/09/16 14:09:45 by aankote          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (_HitPoint > 0 && this->_EnergyPoint > 0 )
    {
        ...
        this->_EnergyPoint --;
        std::cout << "• ClapTrap " << this->_Name << " repairs itself and gains " << amount << " hit points. Hit points remaining: " << this->_HitPoint << std::endl;
    }
    else 
    {
...
void ClapTrap::takeDamage(unsigned int amount)
{
    if (_HitPoint > 0 && this->_EnergyPoint)
    {
        if (amount > (unsigned int)this->_HitPoint)
        {
            ...
            std::cout << " damage and is destroyed." << std::endl;
        }
        else
        {
            this->_HitPoint -= amount;
