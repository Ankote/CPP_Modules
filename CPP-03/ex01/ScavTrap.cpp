...
/*   Updated: 2023/09/16 14:24:43 by aankote          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap()
{
   ...
   this->setName("Boot");
   std::cout << "ClapTrap has Become ScavTrap!" << std::endl;
}
...
void ScavTrap::attack(const std::string& target)
{
    ...
    {
        std::cout << "•• ScavTrap " << this->getName() << " can't attack. No hit points or energy points left." << std::endl;
    }
...
ScavTrap::ScavTrap (std::string name) : ClapTrap (name)
{
   ...
   this->setAttackDamage(20);
   this->setName(name);
   std::cout << "ClapTrap " << name << " has Become ScavTrap!" << std::endl;
}
