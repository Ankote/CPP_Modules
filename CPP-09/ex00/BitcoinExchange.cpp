...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/19 10:07:41 by aankote           #+#    #+#             */
/*   Updated: 2023/10/22 18:31:28 by aankote          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t nbrSpaces(std::string &value)
{
    size_t cpt = 0;
    size_t i = 0;
    while(value[i])
...
bool checkLine(std::string &line)
{
    ...
    if(date.length() != 11 || ft_trim(date).length() != 10 || nbrSpaces(value) != 1 )
        return (false);
